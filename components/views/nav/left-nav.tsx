...
const LeftNav = () => {
  return (
    <div className={"flex fixed left-0 top-0 gap-3 p-8 w-full flex-row md:flex-col md:h-full md:w-[120px] z-20"}>
      ...
      <a className={"rounded-full content-center flex justify-center aspect-square items-center"}
         href={"https://github.com/AbdoWise-z"} target={"_blank"}>
      ...
      <a className={"rounded-full content-center flex justify-center aspect-square items-center"}
         href={"https://leetcode.com/u/AQ9WrgwBmj/"} target={"_blank"}>
      ...
      <Tooltip delayDuration={0.4}>
        <TooltipTrigger className={"rounded-full content-center flex justify-center aspect-square items-center"}>
          <SecretContent focusMaskWidth={60} secret={(
            <svg width={24} height={24} role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <title>Discord</title>
              <path
